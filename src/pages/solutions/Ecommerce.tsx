...
const features = [
  {
    ...
    description: 'Maximize your e-commerce conversion rates.'
  },
  {
    icon: TrendingUp,
    title: 'Sales Growth',
    description: 'Strategies to increase online sales revenue.'
  },
  {
    icon: CreditCard,
    title: 'Payment Solutions',
    description: 'Seamless checkout experiences for customers.'
  },
  {
    icon: Truck,
  ...
  },
  {
    ...
    description: 'Data-driven decisions for your store.'
  },
  {
    icon: Users,
      ...
      >
        <div className="flex items-center justify-center h-full">
          <div className="text-center text-white max-w-4xl px-4">
            ...
            >
              Drive online sales and grow your e-commerce business
            </motion.p>
          </div>
        </div>
      </ParallaxSection>
