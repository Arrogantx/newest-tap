      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center px-4 sm:px-6 lg:px-8" style={{ height: '72px' }}>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <button className="px-6 py-2.5 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors">
              Get Started
            </button>
          </div>
        ...
        {isOpen && (
          <div className="lg:hidden border-t border-gray-100">
            <div className="px-4 py-6 space-y-4">
              <MobileNavSection title="Services" items={services[0].items} />
              <MobileNavSection title="Solutions" items={solutions[0].items} />
              <MobileNavSection title="Resources" items={resources[0].items} />
              <Link 
                to="/contact"
              ...
              <button className="w-full px-6 py-3 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors">
                Get Started
              </button>
            </div>
          </div>
...
const NavLink = ({ label, items, isActive, onMouseEnter, onMouseLeave }) => (
  <div 
    className="relative"
...
const MobileNavSection = ({ title, items }) => {
  const [isOpen, setIsOpen] = useState(false);
